...
import (
	...
	"github.com/bifidokk/awesome-chat/auth/internal/sys"
	"github.com/bifidokk/awesome-chat/auth/internal/sys/codes"
	"github.com/bifidokk/awesome-chat/auth/internal/sys/validate"
...
// GRPCStatusInterface defines an interface for types that provide a gRPC status.
type GRPCStatusInterface interface {
	GRPCStatus() *status.Status
}

// ErrorCodesInterceptor is a gRPC interceptor that handles error codes by examining and potentially modifying the error returned from a handler.
