...
//go:generate minimock -i github.com/bifidokk/awesome-chat/auth/internal/repository.UserRepository -o user_repository_minimock.go -n UserRepositoryMock -p mocks
...
type UserRepositoryMock struct {
	...
	funcCreate          func(ctx context.Context, data *model.CreateUser) (i1 int64, err error)
	inspectFuncCreate   func(ctx context.Context, data *model.CreateUser)
	...
	funcUpdate          func(ctx context.Context, data *model.UpdateUser) (err error)
	inspectFuncUpdate   func(ctx context.Context, data *model.UpdateUser)
...
func (mmCreate *mUserRepositoryMockCreate) Expect(ctx context.Context, data *model.CreateUser) *mUserRepositoryMockCreate {
	...
	mmCreate.defaultExpectation.params = &UserRepositoryMockCreateParams{ctx, data}
...
// ExpectDataParam2 sets up expected param data for UserRepository.Create
func (mmCreate *mUserRepositoryMockCreate) ExpectDataParam2(data *model.CreateUser) *mUserRepositoryMockCreate {
	if mmCreate.mock.funcCreate != nil {
		mmCreate.mock.t.Fatalf("UserRepositoryMock.Create mock is already set by Set")
	}
...
func (mmCreate *mUserRepositoryMockCreate) Inspect(f func(ctx context.Context, data *model.CreateUser)) *mUserRepositoryMockCreate {
...
func (mmCreate *mUserRepositoryMockCreate) Set(f func(ctx context.Context, data *model.CreateUser) (i1 int64, err error)) *UserRepositoryMock {
	if mmCreate.defaultExpectation != nil {
...
// Then helper
func (mmCreate *mUserRepositoryMockCreate) When(ctx context.Context, data *model.CreateUser) *UserRepositoryMockCreateExpectation {
	if mmCreate.mock.funcCreate != nil {
		mmCreate.mock.t.Fatalf("UserRepositoryMock.Create mock is already set by Set")
	}
	...
	expectation := &UserRepositoryMockCreateExpectation{
		mock:   mmCreate.mock,
		params: &UserRepositoryMockCreateParams{ctx, data},
	}
...
func (mmCreate *UserRepositoryMock) Create(ctx context.Context, data *model.CreateUser) (i1 int64, err error) {
	...
	mm_params := UserRepositoryMockCreateParams{ctx, data}
	...
	if mmCreate.CreateMock.defaultExpectation != nil {
		...
		mm_got := UserRepositoryMockCreateParams{ctx, data}
		...
		if mm_want_ptrs != nil {
			...
			if mm_want_ptrs.data != nil && !minimock.Equal(*mm_want_ptrs.data, mm_got.data) {
				mmCreate.t.Errorf("UserRepositoryMock.Create got unexpected parameter data, want: %#v, got: %#v%s\n", *mm_want_ptrs.data, mm_got.data, minimock.Diff(*mm_want_ptrs.data, mm_got.data))
			}
	...
	mmCreate.t.Fatalf("Unexpected call to UserRepositoryMock.Create. %v %v", ctx, data)
	return
}
...
func (mmUpdate *mUserRepositoryMockUpdate) Expect(ctx context.Context, data *model.UpdateUser) *mUserRepositoryMockUpdate {
	...
	mmUpdate.defaultExpectation.params = &UserRepositoryMockUpdateParams{ctx, data}
...
// ExpectDataParam2 sets up expected param data for UserRepository.Update
func (mmUpdate *mUserRepositoryMockUpdate) ExpectDataParam2(data *model.UpdateUser) *mUserRepositoryMockUpdate {
	if mmUpdate.mock.funcUpdate != nil {
		mmUpdate.mock.t.Fatalf("UserRepositoryMock.Update mock is already set by Set")
	}
...
func (mmUpdate *mUserRepositoryMockUpdate) Inspect(f func(ctx context.Context, data *model.UpdateUser)) *mUserRepositoryMockUpdate {
...
func (mmUpdate *mUserRepositoryMockUpdate) Set(f func(ctx context.Context, data *model.UpdateUser) (err error)) *UserRepositoryMock {
	if mmUpdate.defaultExpectation != nil {
...
// Then helper
func (mmUpdate *mUserRepositoryMockUpdate) When(ctx context.Context, data *model.UpdateUser) *UserRepositoryMockUpdateExpectation {
	if mmUpdate.mock.funcUpdate != nil {
		mmUpdate.mock.t.Fatalf("UserRepositoryMock.Update mock is already set by Set")
	}
	...
	expectation := &UserRepositoryMockUpdateExpectation{
		mock:   mmUpdate.mock,
		params: &UserRepositoryMockUpdateParams{ctx, data},
	}
...
func (mmUpdate *UserRepositoryMock) Update(ctx context.Context, data *model.UpdateUser) (err error) {
	...
	mm_params := UserRepositoryMockUpdateParams{ctx, data}
	...
	if mmUpdate.UpdateMock.defaultExpectation != nil {
		...
		mm_got := UserRepositoryMockUpdateParams{ctx, data}
		...
		if mm_want_ptrs != nil {
			...
			if mm_want_ptrs.data != nil && !minimock.Equal(*mm_want_ptrs.data, mm_got.data) {
				mmUpdate.t.Errorf("UserRepositoryMock.Update got unexpected parameter data, want: %#v, got: %#v%s\n", *mm_want_ptrs.data, mm_got.data, minimock.Diff(*mm_want_ptrs.data, mm_got.data))
			}
	...
	mmUpdate.t.Fatalf("Unexpected call to UserRepositoryMock.Update. %v %v", ctx, data)
	return
}
