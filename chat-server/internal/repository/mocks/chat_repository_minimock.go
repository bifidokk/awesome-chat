...
//go:generate minimock -i github.com/bifidokk/awesome-chat/chat-server/internal/repository.ChatRepository -o chat_repository_minimock.go -n ChatRepositoryMock -p mocks
...
func (mmCreate *mChatRepositoryMockCreate) Expect(ctx context.Context, data *model.CreateChat) *mChatRepositoryMockCreate {
...
func (mmCreate *mChatRepositoryMockCreate) ExpectDataParam2(data *model.CreateChat) *mChatRepositoryMockCreate {
	if mmCreate.mock.funcCreate != nil {
		mmCreate.mock.t.Fatalf("ChatRepositoryMock.Create mock is already set by Set")
	}
...
func (mmCreate *mChatRepositoryMockCreate) Inspect(f func(ctx context.Context, data *model.CreateChat)) *mChatRepositoryMockCreate {
...
func (mmCreate *mChatRepositoryMockCreate) Set(f func(ctx context.Context, data *model.CreateChat) (i1 int64, err error)) *ChatRepositoryMock {
	if mmCreate.defaultExpectation != nil {
...
// Then helper
func (mmCreate *mChatRepositoryMockCreate) When(ctx context.Context, data *model.CreateChat) *ChatRepositoryMockCreateExpectation {
	if mmCreate.mock.funcCreate != nil {
		mmCreate.mock.t.Fatalf("ChatRepositoryMock.Create mock is already set by Set")
	}
...
func (mmCreate *ChatRepositoryMock) Create(ctx context.Context, data *model.CreateChat) (i1 int64, err error) {
	...
	if mmCreate.CreateMock.defaultExpectation != nil {
		...
		if mm_want_ptrs != nil {
			...
			if mm_want_ptrs.data != nil && !minimock.Equal(*mm_want_ptrs.data, mm_got.data) {
				mmCreate.t.Errorf("ChatRepositoryMock.Create got unexpected parameter data, want: %#v, got: %#v%s\n", *mm_want_ptrs.data, mm_got.data, minimock.Diff(*mm_want_ptrs.data, mm_got.data))
			}
