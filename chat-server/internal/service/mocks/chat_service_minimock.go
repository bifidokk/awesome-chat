...
//go:generate minimock -i github.com/bifidokk/awesome-chat/chat-server/internal/service.ChatService -o chat_service_minimock.go -n ChatServiceMock -p mocks
...
type ChatServiceMock struct {
	...
	funcCreate          func(ctx context.Context, data *model.CreateChat) (i1 int64, err error)
	inspectFuncCreate   func(ctx context.Context, data *model.CreateChat)
...
func (mmCreate *mChatServiceMockCreate) Expect(ctx context.Context, data *model.CreateChat) *mChatServiceMockCreate {
	...
	mmCreate.defaultExpectation.params = &ChatServiceMockCreateParams{ctx, data}
...
// ExpectDataParam2 sets up expected param data for ChatService.Create
func (mmCreate *mChatServiceMockCreate) ExpectDataParam2(data *model.CreateChat) *mChatServiceMockCreate {
	if mmCreate.mock.funcCreate != nil {
		mmCreate.mock.t.Fatalf("ChatServiceMock.Create mock is already set by Set")
	}
...
func (mmCreate *mChatServiceMockCreate) Inspect(f func(ctx context.Context, data *model.CreateChat)) *mChatServiceMockCreate {
...
func (mmCreate *mChatServiceMockCreate) Set(f func(ctx context.Context, data *model.CreateChat) (i1 int64, err error)) *ChatServiceMock {
	if mmCreate.defaultExpectation != nil {
...
// Then helper
func (mmCreate *mChatServiceMockCreate) When(ctx context.Context, data *model.CreateChat) *ChatServiceMockCreateExpectation {
	if mmCreate.mock.funcCreate != nil {
		mmCreate.mock.t.Fatalf("ChatServiceMock.Create mock is already set by Set")
	}
	...
	expectation := &ChatServiceMockCreateExpectation{
		mock:   mmCreate.mock,
		params: &ChatServiceMockCreateParams{ctx, data},
	}
...
func (mmCreate *ChatServiceMock) Create(ctx context.Context, data *model.CreateChat) (i1 int64, err error) {
	...
	mm_params := ChatServiceMockCreateParams{ctx, data}
	...
	if mmCreate.CreateMock.defaultExpectation != nil {
		...
		mm_got := ChatServiceMockCreateParams{ctx, data}
		...
		if mm_want_ptrs != nil {
			...
			if mm_want_ptrs.data != nil && !minimock.Equal(*mm_want_ptrs.data, mm_got.data) {
				mmCreate.t.Errorf("ChatServiceMock.Create got unexpected parameter data, want: %#v, got: %#v%s\n", *mm_want_ptrs.data, mm_got.data, minimock.Diff(*mm_want_ptrs.data, mm_got.data))
			}
	...
	mmCreate.t.Fatalf("Unexpected call to ChatServiceMock.Create. %v %v", ctx, data)
	return
}
